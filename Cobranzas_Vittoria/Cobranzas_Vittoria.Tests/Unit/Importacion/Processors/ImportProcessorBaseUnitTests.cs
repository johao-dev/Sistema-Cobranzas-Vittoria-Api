...
public class ImportProcessorBaseUnitTests
{
    ...
    public void ValidarEstructura_MasDe100Filas_LanzaDatosInvalidosConDemasiadasFilas()
    {
        ...
        Assert.That(ex.Errores[0].CodigoError, Is.EqualTo("DEMASIADAS_FILAS"));
    ...
    public void ValidarEstructura_FaltaEncabezadoRequerido_LanzaEstructuraInvalida()
    {
        ...
        Assert.That(ex.Codigo, Is.EqualTo("ENCABEZADOS_INCORRECTOS"));
    ...
    public void MapearFilas_UnaFilaInvalidaPorKeyNotFound_AcumulaErrorConFilaCorrecta()
    {
        ...
        Assert.That(errores[0].CodigoError, Is.EqualTo("CAMPO_REQUERIDO"));
    }
    ...
    public void MapearFilas_UnaFilaInvalidaPorDatosInvalidos_PreservaDetalleOriginal()
    {
        ...
        Assert.That(errores[0].CodigoError, Is.EqualTo("REGLA_NEGOCIO"));
    ...
    public void MapearFilas_TresFilasInvalidasDeDistintoTipo_AcumulaTodosLosErrores()
    {
        ...
        Assert.That(errores.Select(e => e.CodigoError), Is.EquivalentTo(new[] { "CAMPO_REQUERIDO", "FORMATO_INVALIDO", "REGLA_NEGOCIO" }));
    }
    ...
    {
        Assert.That(ImportProcessorBase<UnidadMedidaImportDto>.MapearCodigoSql(50001), Is.EqualTo("CAMPO_OBLIGATORIO"));
    }

    [Test]
    public void MapearCodigoSql_50002_DevuelveValorDuplicadoEnArchivo()
    {
        Assert.That(ImportProcessorBase<UnidadMedidaImportDto>.MapearCodigoSql(50002), Is.EqualTo("VALOR_DUPLICADO_EN_ARCHIVO"));
    }

    [Test]
    public void MapearCodigoSql_50003_DevuelveValorYaExisteEnBd()
    {
        Assert.That(ImportProcessorBase<UnidadMedidaImportDto>.MapearCodigoSql(50003), Is.EqualTo("VALOR_YA_EXISTE_EN_BD"));
    }

    [Test]
    public void MapearCodigoSql_50004_DevuelveFkNoExiste()
    {
        Assert.That(ImportProcessorBase<UnidadMedidaImportDto>.MapearCodigoSql(50004), Is.EqualTo("FK_NO_EXISTE"));
    }

    [Test]
    public void MapearCodigoSql_FueraDeRango_DevuelveErrorValidacionN()
    {
        Assert.That(ImportProcessorBase<UnidadMedidaImportDto>.MapearCodigoSql(50099), Is.EqualTo("ERROR_VALIDACION_50099"));
        Assert.That(ImportProcessorBase<UnidadMedidaImportDto>.MapearCodigoSql(50100), Is.EqualTo("ERROR_VALIDACION_50100"));
    }
