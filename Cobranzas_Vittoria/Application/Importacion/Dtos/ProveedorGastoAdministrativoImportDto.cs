...
/// <summary>
/// DTO de importacion para la entidad <c>maestra.ProveedorGastoAdministrativo</c>.
///
/// El shape de este DTO coincide 1-a-1 con el TVP <c>maestra.TVP_ProveedorGastoAdministrativo</c>:
...
///   - <c>RazonSocial</c>: requerido, max 200 chars, unica intra-archivo y en BD.
///   - <c>Ruc</c>: opcional, max 20 chars. Unico en BD cuando se proporciona
///                  (la tabla tiene indice UNIQUE filtrado por IS NOT NULL).
///   - <c>IdCategoriaGasto</c>: opcional, FK valida a maestra.CategoriaGasto.
///   - Resto de campos: opcionales.
/// </summary>
public class ProveedorGastoAdministrativoImportDto
{
    /// <summary>Razon social del proveedor. Requerido, max 200 chars, unica en BD.</summary>
    public string RazonSocial { get; set; } = string.Empty;

    /// <summary>RUC del proveedor. Opcional, max 20 chars, unico en BD cuando se proporciona.</summary>
    public string? Ruc { get; set; }

    /// <summary>Persona de contacto. Opcional, max 120 chars.</summary>
    ...
    /// <summary>FK opcional a maestra.CategoriaGasto.</summary>
