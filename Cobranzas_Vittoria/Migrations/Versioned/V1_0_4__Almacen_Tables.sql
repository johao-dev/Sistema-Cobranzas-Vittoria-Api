...
ALTER TABLE VittoriaComprasDB_New.almacen.KardexMovimiento WITH NOCHECK ADD CONSTRAINT CK_KardexMovimiento_Tipo CHECK (([TipoMovimiento] = N'AJUSTE'
OR [TipoMovimiento] = N'SALIDA'
OR [TipoMovimiento] = N'ENTRADA'
OR [TipoMovimiento] = N'INVENTARIO_INICIAL'));
