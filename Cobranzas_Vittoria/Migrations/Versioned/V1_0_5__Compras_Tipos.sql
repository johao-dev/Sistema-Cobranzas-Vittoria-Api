CREATE TYPE TVP_CompraDetalle AS TABLE (
	IdMaterial int NOT NULL,
	Cantidad decimal(18, 2) NOT NULL,
	PrecioUnitario decimal(18, 2) NOT NULL
);

CREATE TYPE TVP_CompraDocumento AS TABLE (
...
CREATE TYPE TVP_OrdenCompraDetalle AS TABLE (
	IdMaterial int NOT NULL,
	Cantidad decimal(18, 2) NOT NULL,
...
CREATE TYPE TVP_RequerimientoDetalle AS TABLE (
	IdMaterial int NOT NULL,
	Cantidad decimal(18, 2) NOT NULL,
	Observacion nvarchar(250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
);
